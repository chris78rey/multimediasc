...
## Corpus Check
- 70 files · ~163,301 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 594 nodes · 831 edges · 68 communities (64 shown, 4 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.83)
...
1. `Files` - 75 edges
2. `desktopState` - 30 edges
3. `trimSpace()` - 26 edges
4. `RunDesktop()` - 20 edges
...
Cohesion: 0.10
Nodes (32): Context, DB, DigitalizacionRow, Duration, ImagenPacienteRow, Time, ImagenPacienteRow, PlanillaDetalle (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (35): batchItem, documentStatusLine(), documentSummary(), ensureZipExtension(), firstNonEmpty(), formatTime(), parsePlanillaInputs(), planillaPatientName() (+27 more)
...
Cohesion: 0.26
Nodes (7): Config, getenv(), LoadEnvConfig(), loadKeyValues(), normalizeAllowedNames(), parseNamesText(), parseRangesText()
...
Cohesion: 0.06
Nodes (28): appendReason(), classifyFileError(), enrichDocuments(), fileKindFromExt(), inspectFile(), isHidden(), isHidden(), fileObservation (+20 more)
...
- **Why does `Open()` connect `Community 1` to `Community 2`, `Community 3`, `Community 5`, `Community 10`, `Community 17`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `trimSpace()` connect `Community 2` to `Community 17`, `Community 5`, `Community 1`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Files` connect `Community 8` to `Community 21`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 24 inferred relationships involving `trimSpace()` (e.g. with `loadKeyValues()` and `normalizeAllowedNames()`) actually correct?**
  _`trimSpace()` has 24 INFERRED edges - model-reasoned connections that need verification._
- **Are the 8 inferred relationships involving `RunDesktop()` (e.g. with `getenv()` and `LoadEnvConfig()`) actually correct?**
  _`RunDesktop()` has 8 INFERRED edges - model-reasoned connections that need verification._
